...
const secondaryGradientLight = "#82C5D4"; // Secondary gradient color
...
const secondaryGradientDark = "#6DAAB9"; // Secondary gradient color for dark mode
...
export const Colors = {
	light: {
		...
		secondaryGradient: secondaryGradientLight,
	...
	dark: {
		...
		secondaryGradient: secondaryGradientDark,
