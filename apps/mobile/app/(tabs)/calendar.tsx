...
import { StyleSheet, View, TouchableOpacity, Modal, SafeAreaView, ScrollView, Animated, StatusBar } from 'react-native';
  ...
  if (isFuture(date) && !isSameDay(date, currentDate)) {
    return (
      <View
        ...
        {...cellProps}>
        <Text style={[style?.text, styles.disabledDayText, { color: colors.subtle }]}>{`${date.getDate()}`}</Text>
      </View>
    );
  }
        ...
        <Modal
          ...
          >
            <View style={[
              ...
              {viewMode === 'view' ? (
                <>
                  <View style={[styles.moodDetails, { backgroundColor: colors.background }]}>
                    <LinearGradient
                      colors={getMoodGradient(selectedMood || MoodType.HAPPY)}
                  ...
                  <View style={styles.moodButtonRow}>
                    <TouchableOpacity
                      style={[
                        styles.moodButton,
                        { 
                          borderColor: selectedMood === MoodType.HAPPY ? 
                            getMoodColor(MoodType.HAPPY, scheme) : colors.subtle
                        },
                        selectedMood === MoodType.HAPPY && [
                    ...
                    <TouchableOpacity
                      style={[
                        styles.moodButton,
                        { 
                          borderColor: selectedMood === MoodType.NEUTRAL ? 
                            getMoodColor(MoodType.NEUTRAL, scheme) : colors.subtle
                        },
                        selectedMood === MoodType.NEUTRAL && [
                          styles.selectedMoodButton,
                    ...
                    <TouchableOpacity
                      style={[
                        styles.moodButton,
                        { 
                          borderColor: selectedMood === MoodType.SAD ? 
                            getMoodColor(MoodType.SAD, scheme) : colors.subtle
                        },
